...
| **Vol. III** (`ep03`) | **Track C: Retrieval-Augmented & Tool-Augmented Inference** | S. Yao et al., *"ReAct"* ([arXiv:2210.03629](https://arxiv.org/abs/2210.03629)); A. Asai et al., *"Self-RAG"* ([arXiv:2310.11511](https://arxiv.org/abs/2310.11511)) | POMDP formulation over augmented action space `A_aug = A_env ∪ L_thought` (Eq. 2.1), dynamic Thought-Action-Observation traces, vocabulary extension `V_aug = V ∪ Γ` with 4 critique token families (`[Retrieve]`, `[IsRel]`, `[IsSup]`, `[IsUse]`), segment-level beam search scoring functional (Eq. 4.1), and 42.9% context token reduction via adaptive retrieval gating. | [Plates I–VII](episodes/ep03_react_and_self_rag/plates/) | [Open Vol. III](https://kunruiw1991.github.io/llm-paper-summary/episodes/ep03_react_and_self_rag/) |
